...
registerBlockType( "lbh/tile-outline-button", {
    title: "Tile with outline button",
    icon: "info",
    category: "hackney",
    parent: [ "lbh/tiles" ],
    attributes: {
    ...
    edit: ({ attributes: { title, content, imageSrc, imageAlt, buttonHref, buttonText }, setAttributes, className }) => 
        <div className={className}>
            ...
            />
            <div class="button-area button-area--outline">
                <RichText
                    value={buttonText} 
                    tagName="p"
                    allowedFormats={[]}
    ...
    save: ({ attributes: { title, content, imageSrc, imageAlt, buttonHref, buttonText }, className }) => 
        <div className="tiles__tile">
            ...
            <div class="tiles__inner">
                ...
                <a class="tiles__button tiles__button--outline" href={buttonHref}>{buttonText}</a>
            </div>
        </div>
    ,
})